                    ...
                    <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                        <div class="menu_section">
                            ...
                            <ul class="nav side-menu">
                                ...
                                <li><a href="orderDetails.php"> <i class="fa fa-flag"></i>Commande clients</a></li>
...
<!--                                    </ul>-->
<!--                                </li>-->
                                <li><a href="addCat.php"><i class="fa fa-archive"></i> Ajouter Categories</a></li>
                                <li><a href="addBrand.php"><i class="fa fa-bank"></i> Ajouter Marque</a></li>
                                <li><a href="addProduct.php"><i class="fa fa-database"></i> Ajouter Produits </a></li>
                                <li><a href="inbox.php"> <i class="fa fa-inbox"></i> Inbox</a></li>

                                <li><a href="website.php"> <i class="fa fa-credit-card"></i> Information Website  </a></li>
                            </ul>
                        </div>
<!--                        <div class="menu_section">-->
<!--                            <h3>Live On</h3>-->
