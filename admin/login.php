        ...
        <div class="animate form login_form">
          <section class="login_content">
            <form action="<?php //echo $_SERVER['PHP_SELF'];?>" method="POST">
              <h1>Formulaire de Connections</h1>
              <div>
              ...
              <div class="separator">
                ...
                <div>
                  ...
                  <p>© <?php echo date('y-m-d');?> Tous droits reservés. Gentelella Alela! est un template Bootstrap 3. Privé et Termes</p>
                </div>
              </div>
            </form>
          </section>
        ...
        <div id="register" class="animate form registration_form">
          <section class="login_content">
            <form action="<?php echo $_SERVER['PHP_SELF'];?>" method="POST" enctype="multipart/form-data">
              ...
              <div>
                <button type="submit" name="register" class="btn btn-default submit"> S'enregistrer </button>
              </div>

              <div class="clearfix"></div>

              <div class="separator">
                <p class="change_link">Etes-vous déjà membre?
                ...
                <div>
                  <h1><i class="fa fa-paw"></i> Gentelella Alela!</h1>
                  <p>&copy; <?php echo date('y-m-d');?> All Rights Reserved. Gentelella Alela! est un template Bootstrap 3 . Privé et Termes</p>
                </div>
              </div>
            </form>
          </section>
