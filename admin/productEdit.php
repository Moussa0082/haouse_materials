        ...
        <div class="">
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2> Produit <small> Modifier Produit </small></h2>
                        ...
                        <div class="x_content">
                            ...
                            <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="" method="POST" enctype="multipart/form-data">
                                ...
                                <!--Category-->
                                <div class="form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12">Selectionne Categories</label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                ...
                                <div class="form-group">
                                    <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                        <button type="submit" class="btn btn-app" name="editProduct"><i class="fa fa-save"></i> Modifier </button>
