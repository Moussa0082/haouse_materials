        ...
        <div class="">
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2> Categories <small> Ajouter Categories </small></h2>
                        ...
                        <div class="x_content">
                            ...
                            <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="" method="POST">
                                ...
                                <div class="form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Nom Categorie <span class="required">*</span>
                                    </label>
                                ...
                                <div class="form-group">
                                    <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                        <button type="submit" class="btn btn-app" name="addCategory"><i class="fa fa-save"></i>Enregistrer</button>
                                    ...
                                    <div class="col-sm-12">
                                        <table id="datatable" class="table table-striped table-bordered dataTable no-footer" role="grid" aria-describedby="datatable_info">
                                            ...
                                            <tr role="row">
                                                ...
                                                <th class="sorting text-center" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" style="width: 298px;" aria-label="Position: activate to sort column ascending"> Nom Categorie</th>
...
<!--                                                        <button type="button" class="btn btn-round btn-danger"><i class="fa fa-times"></i> Delete </button>-->
                                                ...
                                                <?php else: ?>
                                                    <tr role="row" class="odd">
                                                        ...
                                                        <td class="text-center">
                                                            Pas Categori à Editer
                                                        </td>
                                                        <td class="text-center">
                                                        Pas Categori à Supprimer
                                                        </td>
                                                    </tr>
                                            <?php endif; ?>
                                            </tbody>
