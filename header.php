                                                ...
                                                <div class="facts">
                                                    <div class="register">
                                                        <form action="#" method="POST">
                                                            <input name="email" placeholder="Address e-mail" type="text" >
                                                            <input name="pass" placeholder="Mot de passe" type="password" >
                                                            <div class="sign-up">
                                                                <input type="submit" name="singin" value="Se connecter"/>
                                                            </div>
                                                        </form>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="facts">
                                                    <div class="register">
                                                        <form action="#" method="POST">
                                                            ...
                                                            <input placeholder="Adress e-mail" name="Email" type="email"  />
                                                            <input placeholder="Numéro de téléphone" name="Phone" type="text" style="margin-top: 15px" />
                                                            <input placeholder="Mot de passe" name="Password" type="password"  />
                                                            <input placeholder="Confirme mot de passe" name="rePassword" type="password"  />
                                                            <div class="sign-up">
                ...
                <nav class="navbar navbar-default">
                    ...
                    <div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
                        <ul class="nav navbar-nav">
                            <li><a href="index.php" class="act">Accueil</a></li>
                            <!-- Mega Menu -->
                            <li>
