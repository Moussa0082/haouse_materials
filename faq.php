<!-- 
	Copy Right Moussa Bane
     2022
-->
<!DOCTYPE html>
<html lang="en">
<head>
<title>Electronic Store a Ecommerce Online Shop | FAQ's </title>
<!-- for-mobile-apps -->
			...
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal" aria-hidden="true">
						&times;</button>
					<h4 class="modal-title" id="myModalLabel">N'attender Plus, Connectez vous!</h4>
				</div>
										...
										<div class="facts">
											<div class="register">
												<form action="#" method="post">			
													...
													<input placeholder="Adress e-mail" name="Email" type="email" required="">	
													<input placeholder="Mot de passe" name="Password" type="password" required="">	
													<input placeholder="Confirme mot de pass" name="Password" type="password" required="">
													<div class="sign-up">
		...
		<div class="container">
			<div class="w3_footer_grids">
				<div class="col-md-3 w3_footer_grid">
					...
					<ul class="address">
						<li><i class="glyphicon glyphicon-map-marker" aria-hidden="true"></i>1234k Bamako, <span>HAMDALLAYE ACI 2000.</span></li>
						<li><i class="glyphicon glyphicon-envelope" aria-hidden="true"></i><a href="#">bane8251@gmail.com</a></li>
