...
<html lang="en">
<head>
<title>Electronic Store a Ecommerce Online Shop | Web Icons</title>
<!-- for-mobile-apps -->
...
<body> 
			...
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal" aria-hidden="true">
						&times;</button>
					<h4 class="modal-title" id="myModalLabel">N'attendezPlus, Connecter vous!</h4>
				</div>
							...
							<div class="sap_tabs">	
								<div id="horizontalTab" style="display: block; width: 100%; margin: 0px;">
									<ul>
										...
										<li class="resp-tab-item" aria-controls="tab_item-1"><span>Créer un compte</span></li>
									</ul>		
										...
										<div class="facts">
											<div class="register">
												<form action="#" method="post">			
													...
													<input placeholder="Adresse e-mail " name="Email" type="email" required="">	
													<input placeholder="Mot de passe" name="Password" type="password" required="">	
													<input placeholder="Confirm mot de passe" name="Password" type="password" required="">
													<div class="sign-up">
	...
	<div class="footer">
		...
		<div class="footer-copy">
			...
			<div class="container">
				<p>&copy;  <?php echo date('y-m-d');?> Electronic Store. All rights reserved | Design by <a href="http://w3layouts.com/">W3layouts</a></p>
			</div>
		</div>
	</div>
	<!-- //footer -->  
