                    ...
                    <div class="col-md-11" id="user-option">
                        ...
                        <ul class="nav nav-tabs" role="tablist">
                            ...
                            <li role="presentation">
                                <a href="#profile" aria-controls="profile" role="tab" class="text-center" data-toggle="tab" style="width: 150px;">Modifier Profil</a>
                            </li>
                            <li role="presentation">
                            ...
                            <li role="presentation">
                                <a href="#settings" aria-controls="settings" role="tab" class="text-center" data-toggle="tab" style="width: 150px;">Ma Carte </a>
                            </li>
                            <?php
                            ...
                            ?>
                            <li role="presentation">
                                <a href="?action=logoutCustomer"  style="width: 150px;" class="text-center"> Déconnection </a>
                            </li>
                        </ul>
                    </div>
                </div>
                                            ...
                                            <?php $userInfo = $userObject->userInfoById(Session::get("userId")); if ($userInfo): ?>
                                                <form action="" method="post" enctype="multipart/form-data">
                                                    <?php while ($info = $userInfo->fetch_assoc()): ?>
                                                        ...
                                                        <div class="form-group">
                                                            <label for="zip">N° Indicatif Du Pays:</label>
                                                            <input type="text" class="form-control" id="zip" name="zip" value="<?php if (strcmp( $info['zip'], "NULL") == 0) echo "Vide"; else echo $info['zip']; ?>" />
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="phone">Téléphone:</label>
                                                            <input type="text" class="form-control" id="phone" name="phone" value="<?php if (strcmp( $info['phone'], "NULL") == 0) echo "Vide"; else echo $info['phone'];?>" />
                                                        </div>
                                                        <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" id="country" name="country" value="<?php if (strcmp( $info['country'], "NULL") == 0) echo "Vide"; else echo $info['country'];?>" />
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="city"> Ville:</label>
                                                            <input type="text" class="form-control" id="city" name="city" value="<?php if (strcmp( $info['city'], "NULL") == 0) echo "Vide"; else echo $info['city'];?>" />
                                                        </div>
                                                        <div class="form-group">
                                                            <button type="submit" class="btn btn-default w3ls-cart" name="update" > <i class="fa fa-thumbs-o-up"></i>Modifier</button>
                                                        </div>
                                                    <?php endwhile; ?>
                                                </form>
                                            <?php endif; ?>
                                ...
                                <div class="mail">
                                    ...
                                    <div class="agile_mail_grids">
                                        <div class="col-md-4 contact-left">
                                            <h4>Adresse</h4>
                                            <p>Bane Corpation HAMDALLAYE ACI 2000
                                            <ul>
                                                <li>Whats APP :+223 82-51-17-23</li>
                                                <li>Telephone :+223 82-51-17-23</li>
                                                <li>Fax :+223 82-51-17-23</li>
                                                <li><a href="mailto:bane8251@gmail.com">bane8251@gmail.com</a></li>
                                            </ul>
                                        </div>
                                        <div class="col-md-7 contact-left">
                                            ...
                                            <form action="" method="post" >
                                                ...
                                                <button name="messageSubmit" type="submit" class="w3ls-cart btn" > <i class="fa fa-envelope-o"></i> Envoyer </button>
                                            </form>
                                        </div>
                                        ...
                                        <table class="table table-striped">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="text-center" style="width: 8%;">Total Prix</th>
                                            ...
                                            <tbody>
                                                <?php while ($cart = $userCart->fetch_assoc()): $i++; ?>
                                                    <tr>
                                                        ...
                                                        <td class="text-center"><?php echo $cart['price']; ?> <em>FCFA</em></td>
                                                        <td class="text-center"><?php echo $cart['quantity']; ?></td>
                                                        <td class="text-center"><?php echo $cart['quantity']*$cart['price'];?> <em>FCFA</em></td>
                                                        <td class="text-center"><?php echo $formateObject->formatDate($cart['date']) ;?></td>
                                                        <td class="text-center"><?php if ($cart['status'] == 0) {echo " Pending ";} else { ?> <a href="?removeid=<?php echo $cart['id']; ?>" class="btn btn-danger" onclick="return confirm('Voulez-vous supprimer ?');"> <i class="fa fa-times"></i> Supprimer </a> <?php  } ?></td>
