                                    ...
                                    <div class="facts">
                                        <div class="register">
                                            <form action="#" method="post">
                                                <input name="Email" placeholder="Adresse E-mail" type="text" required="">
                                                <input name="Password" placeholder="Mot de passe" type="password" required="">
                                                <div class="sign-up">
                                                    <input type="submit" value="Se connecetr"/>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
        ...
        <nav class="navbar navbar-default">
            ...
            <div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
                <ul class="nav navbar-nav">
                    ...
                    <!-- Mega Menu -->
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">Produuis <b class="caret"></b></a>
                            ...
                            <div class="row">
                                <div class="col-sm-3">
                                    <ul class="multi-column-dropdown">
                                        ...
                                        <li><a href="products.php">Populaire Models</a></li>
                    ...
                    <?php if (Session::get("userLogin")): ?>
                        <li><a href="?action=logoutCustomer">Déconnection</a></li>
                    <?php endif; ?>
                </ul>
            </div>
        </nav>
