...
<?php
    ...
    class Product
    {
        ...
        public function insertProduct($data, $image)
        {
            ...
            if (empty($file_name) || empty($proName) || empty($category) || empty($brand) || empty($proDescription) || empty($proPrice) || empty($proType))
            {
                echo "<div class='alert alert-danger alert-dismissable'>
                          ...
                          <strong>Warning !</strong> Veuiller remplir ce champ.
                      </div>";
            }
            else
            {
                ...
                echo "<div class='alert alert-success alert-dismissable'>
                         <a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a>
                         <strong>Succès! </strong>"; echo $proName; echo " Insérer avec succès.";
                echo "</div>";
            }
        ...
        public function updateProductById($id, $data, $image)
        {
            ...
            if (empty($file_name) && empty($proName) && empty($category) && empty($brand) && empty($proDescription) && empty($proPrice) && empty($proType))
            {
                echo "<div class='alert alert-warning alert-dismissable'>
                          <a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a>
                          <strong> Avertissement !</strong> Veuiller remplir ce champ.
                      </div>";
            }
            //Image
            if (!empty($file_name))
        ...
        public function shiftToPendingById($productId)
        {
            ...
            echo "<div class='alert alert-warning alert-dismissable'>
                         <a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a>
                         <strong>Success! </strong> Produit ajouté comme non livrer.";
            echo "</div>";
        }
        ...
        public function pendingToShiftById($productId)
        {
            ...
            echo "<div class='alert alert-info alert-dismissable'>
                         <a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a>
                         <strong>Success! </strong>Produit ajouté comme livrer.";
            echo "</div>";
        }
