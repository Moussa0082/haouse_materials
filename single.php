                    ...
                    <div class="col-md-8 single-right">
                        ...
                        <div class="simpleCart_shelfItem">
                            ...
                            <form class="navbar-form navbar-left" method="post" action="">
                                ...
                                <button type="submit" class="btn btn-default w3ls-cart" name="addCart" style="text-transform: none;">Ajouter au Panier</button>
                            </form>
                        </div>
                    </div>
            <!--End-->
		...
		<div class="container">
			<div class="sap_tabs">	
				<div id="horizontalTab1" style="display: block; width: 100%; margin: 0px;">
					<ul>
						<li class="resp-tab-item" aria-controls="tab_item-0" role="tab"><span>Information Produit</span></li>
                        <?php if (Session::get("userLogin")): ?>
						    <li class="resp-tab-item" aria-controls="tab_item-1" role="tab"><span>Commentaires</span></li>
                        <?php endif; ?>
                    </ul>
						...
						<div class="review_grids">
                            ...
                            <form action="#review" id="review" method="post">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="Name" id="usr" placeholder="Votre Nom" />
                                </div>
                                <div class="form-group" style="position: relative;right: 15px;">
                                    <label for="pwd" style="position: relative;left: 15px;">E-mail:</label>
                                    <input type="email" name="Email" class="form-control" id="pwd" placeholder="Votre E-mail" />
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="Telephone" class="form-control" id="ph" placeholder="Votre Téléphone" />
                                </div>
                                <div class="form-group">
                                    <label for="comment">Commentaires:</label>
                                    <textarea class="form-control" name="Review" rows="5" id="comment" placeholder="Votre Commentaires"></textarea>
                                </div>
                                <div class="form-group">
				...
				<li>
					<div class="w3l_related_products_grid">
						<div class="agile_ecommerce_tab_left mobiles_grid">
							...
							<div class="simpleCart_shelfItem"> 
								<p class="flexisel_ecommerce_cart"><i class="item_price"><?php echo $related['price'];?> </i> <em>FCFA</em></p>
							</div>
                            <div>
                                <a href="single.php?proid=<?php echo $related['proid'];?>" class="btn btn-default w3ls-cart">Ajouter au Panier </a>
                            </div>
						</div>
					</div>
				</li>
